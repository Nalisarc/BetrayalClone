...
** Room Object
The room object is the representation of a room tile. It contains information about the tile and methods for accessing and changing the data
In the end the room object could be represented with a table.

| Room #  | Name           | Number of Doors | Connections | Rotation |
|---------+----------------+-----------------+-------------+----------|
| (0,0,0) | Enterance Hall |               3 |             |        0 |
 #+name: Room_Object
 #+BEGIN_SRC python
   class Room(object):
